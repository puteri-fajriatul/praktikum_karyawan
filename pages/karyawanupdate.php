    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            if (isset($_POST['button_simpan'])) {
                ...
                $status_menikah = $_POST['status'];

                $updateSQL = "UPDATE `karyawan` SET `nik` = ?, `nama_karyawan` = ?, `jenis_kelamin` = ?, `status` = ? WHERE `karyawan`.`id` = ?";
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" name="status" required>
                    ...
                    <option value="Menikah Anak 0" <?php echo ($data['status'] == 'Menikah Anak 0') ? " selected" : "" ?>>Menikah Anak 0</option>
                    <option value="Menikah Anak 1" <?php echo ($data['status'] == 'Menikah Anak 1') ? " selected" : "" ?>>Menikah Anak 1</option>
                    <option value="Menikah Anak 2" <?php echo ($data['status'] == 'Menikah Anak 2') ? " selected" : "" ?>>Menikah Anak 2</option>
                </select>
            </div>
